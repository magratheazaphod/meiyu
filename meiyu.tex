...
In the global mean, observations show that the tropospheric jet is shifting poleward, in tandem with mid-latitude tropospheric heating and the expansion of the Hadley circulation \citep{Fu2006,Archer2008}. This contradicts our finding at the regional level that the jet has generally shifted southward over East Asia. However, recent work finds that the latitude of the tropospheric jet over the Pacific is controlled by the state of Pacific Ocean SST. Furthermore, preferential heating of the eastern Pacific warm pool under global warming continues to draw the Pacific jet southward in both the CMIP 3 and CMIP 5 model suites \citep{Park2014}.
